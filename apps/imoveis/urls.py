...
urlpatterns = [
    ...
    path("<uuid:pk>/compartilhar/", views.compartilhar_imovel, name="compartilhar_imovel"),
    path("<uuid:pk>/compartilhamentos/<int:compartilhamento_id>/remover/", views.remover_compartilhamento, name="remover_compartilhamento"),
